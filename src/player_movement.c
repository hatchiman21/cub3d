...
void	move_player_extend(t_cub3d *data)
{
	if (mlx_is_key_down(data->mlx_data.mlx, MLX_KEY_A)
		&& !touch(data->player.x + SPEED * sin(data->player.angle),
		data->player.y - SPEED * cos(data->player.angle), data))
	{
...
void	move_player(t_cub3d *data)
{
	if (mlx_is_key_down(data->mlx_data.mlx, MLX_KEY_W)
		&& !touch(data->player.x + SPEED * cos(data->player.angle),
		data->player.y + SPEED * sin(data->player.angle), data))
	{
